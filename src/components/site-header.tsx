  ...
  return (
    <header className="relative z-20 mx-auto flex w-full max-w-6xl items-center justify-between px-4 py-5 sm:px-6">
      <a href="/" className="group flex items-center gap-2">
        <span
          aria-hidden
          className="grid h-11 w-11 place-items-center rounded-[1.1rem] border-[3px] border-[var(--ink)] bg-[var(--accent)] shadow-[4px_4px_0_var(--ink)] transition-transform group-hover:translate-y-[1px] group-hover:shadow-[3px_3px_0_var(--ink)]"
        >
          <span className="text-lg font-black text-[var(--ink)]">S</span>
        </span>
